...
export function installDemoState(): void {
  ...
  useAppStore.getState().set({
    ...
    room: {
      ...
      members: [
        { id: 'u1', nickname: '林舟', role: 'owner', isServerAdmin: false, isOnline: true, joinedAt: Date.now() - 86_400_000, lastSeenAt: Date.now() },
        { id: 'u2', nickname: 'Mori', role: 'member', isServerAdmin: false, isOnline: true, joinedAt: Date.now() - 60_000, lastSeenAt: Date.now() },
        { id: 'u3', nickname: 'Kite', role: 'member', isServerAdmin: false, isOnline: true, joinedAt: Date.now() - 30_000, lastSeenAt: Date.now() },
        { id: 'u4', nickname: '阿岚', role: 'member', isServerAdmin: false, isOnline: true, joinedAt: Date.now() - 20_000, lastSeenAt: Date.now() },
      ],
      queue: [
