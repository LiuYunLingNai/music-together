...
interface ClassicPlayerStageProps {
  onPlay: () => void
  onPause: () => void
 ...
 * 经典播放器舞台。
 *
 * 本组件是从改造前的 AudioPlayer 原样抽出的布局实现，
 * 行为与改造前完全一致 —— 它是 Mineradio 舞台的可靠回退入口。
 */
export function ClassicPlayerStage({
  onPlay,
  onPause,
  onSeek,
  onLyricSeek,
